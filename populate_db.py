...
def populate():
    ...
    members = [
        {'user': users[0], 'date-of-birth': '1995-05-25', 'place-of-birth': 'New-York', 'city-of-residence': 'Miami',
         'phone-number': '0606060606', 'borrowings-number': 3},
        {'user': users[1], 'date-of-birth': '2000-07-27', 'place-of-birth': 'Los Angeles', 'city-of-residence': 'Miami',
         'phone-number': '0606060607', 'borrowings-number': 1},
        {'user': users[2], 'date-of-birth': '2005-09-29', 'place-of-birth': 'Lille', 'city-of-residence': 'Paris',
    ...
    for i, member in enumerate(members):
        Member.objects.create(
            ...
            borrowings_number=member['borrowings_number']
        )
